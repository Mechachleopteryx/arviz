(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1fdd6b48-50b8-454d-9c01-060dcf5e96a9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1fdd6b48-50b8-454d-9c01-060dcf5e96a9' but no matching script tag was found.")
        }
